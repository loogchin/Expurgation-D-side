...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['ExTricky D-Side'],
		['์G land | Channel',	'g',		'Art/Music',						'https://www.youtube.com/channel/UCY_M7b7-aOV4oeJ9Exgh7gQ',	0xFF6475F3],
		['์Nong vanila',		'nong',		'Coder/animation/chart',					'https://www.youtube.com/channel/UCGwph3rtuvm9D7yvjceZBbg',	0xFF6475F3],
		[''],
		['Psych Engine Team'],
