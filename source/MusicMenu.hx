...
class MusicMenu extends MusicBeatState
{
    ...
    var tapeRaze:FlxSprite = new FlxSprite().loadGraphic(Paths.image('clown/menu/music/Cassette Rozebud','shared'));
    var tapeJads:FlxSprite = new FlxSprite().loadGraphic(Paths.image('clown/menu/music/Cassette Jads','shared'));
    var tapeYing:FlxSprite = new FlxSprite().loadGraphic(Paths.image('clown/menu/music/Cassette YingYang','shared'));
    ...
    override function create()
    {
        ...
        var bg:FlxSprite = new FlxSprite(-10,-10).loadGraphic(Paths.image('clown/menu/freeplay/RedBG','shared'));
		add(bg);
		var hedge:FlxSprite = new FlxSprite(-810,-335).loadGraphic(Paths.image('clown/menu/freeplay/hedge','shared'));
		hedge.setGraphicSize(Std.int(hedge.width * 0.65));
		add(hedge);
        
        var repeatLine:FlxBackdrop = new FlxBackdrop(Paths.image('clown/menu/music/MusicRepeatLines','shared'),1,1,false,true);
        repeatLine.velocity.set(0,14);
        repeatLine.screenCenter();
        repeatLine.x += 440;
        add(repeatLine);

        var menu:FlxSprite = new FlxSprite().loadGraphic(Paths.image('clown/menu/music/Red Box Music Menu','shared'));
        menu.screenCenter();
