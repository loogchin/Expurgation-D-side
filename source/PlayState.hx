...
{
	var tstatic:FlxSprite = new FlxSprite(0,0).loadGraphic(Paths.image('clown/TrickyStatic','shared'), true, 320, 180);
	...
	override public function create()
	{
		...
		var cover:FlxSprite = new FlxSprite(-180,755).loadGraphic(Paths.image('clown/fourth/cover','shared'));
		var hole:FlxSprite = new FlxSprite(50,530).loadGraphic(Paths.image('clown/fourth/Spawnhole_Ground_BACK','shared'));
		var converHole:FlxSprite = new FlxSprite(7,578).loadGraphic(Paths.image('clown/fourth/Spawnhole_Ground_COVER','shared'));
			...
			case 'auditorHell':
				{
					...
					var bg:FlxSprite = new FlxSprite(-10, -10).loadGraphic(Paths.image('clown/fourth/bg','shared'));
					...
					var energyWall:FlxSprite = new FlxSprite(1350,-690).loadGraphic(Paths.image("clown/fourth/Energywall"));
					energyWall.antialiasing = true;
					energyWall.scrollFactor.set(0.9, 0.9);
					add(energyWall);
					
					var stageFront:FlxSprite = new FlxSprite(-350, -355).loadGraphic(Paths.image('clown/fourth/daBackground'));
		...
		if (curStage == 'auditorHell')
		{
			...
			cloneOne.frames = Paths.getSparrowAtlas('clown/fourth/Clone','shared');
			cloneTwo.frames = Paths.getSparrowAtlas('clown/fourth/Clone','shared');
			cloneOne.alpha = 0;
			cloneTwo.alpha = 0;
			cloneOne.animation.addByPrefix('clone','Clone1',24,false);
			cloneTwo.animation.addByPrefix('clone','Clone1',24,false);
			cloneOne.setGraphicSize(Std.int(cloneOne.width * 0.8));
			cloneTwo.setGraphicSize(Std.int(cloneTwo.width * 0.8));
			...
			/*if(dad.curCharacter == 'exTricky')
			{
				...
				exSpikes.frames = Paths.getSparrowAtlas('clown/fourth/FloorSpikes','shared');
		...
		if (SONG.song.toLowerCase() == "expurgation") {
		    preload('clown/fourth/Clone','shared');
			preload('clown/fourth/mech/Sign_Post_Mechanic','shared');
			preload('clown/fourth/mech/HP GREMLIN','shared');
			//preload('clown/fourth/FloorSpikes','shared');
		}
		...
		if (SONG.song.toLowerCase() == 'expurgation')
			{
				switch (curStep)
				{
					case 2080 | 2084 | 2088 | 2092 | 2096 | 2100 | 2104 | 2108 | 2112 | 2114 | 2116 | 2118 | 2120 | 2121 | 2122 | 2123 | 2124 | 2125 | 2126 | 2127:
						FlxTween.tween(FlxG.camera, {zoom: FlxG.camera.zoom + 0.05}, 0.3, {ease: FlxEase.cubeInOut});
					case 2128:
						FlxTween.tween(FlxG.camera, {zoom: FlxG.camera.zoom = 0.5}, 0.3, {ease: FlxEase.cubeInOut});
	...
	function randomStopSign()
		{
			doStopSign(FlxG.random.int(0,3));
		}
	function doStopSign(sign:Int = 0, fuck:Bool = false)
	{
		...
		daSign.frames = Paths.getSparrowAtlas('clown/fourth/mech/Sign_Post_Mechanic','shared');
		daSign.animation.addByPrefix('sign1','Signature Stop Sign 1',24, false);
		daSign.animation.addByPrefix('sign3','Signature Stop Sign 3',24, false);
		daSign.animation.addByPrefix('sign4','Signature Stop Sign 4',24, false);
	...
	function doGremlin(hpToTake:Int, duration:Int,persist:Bool = false)
	{
		...
		gramlan.frames = Paths.getSparrowAtlas('clown/fourth/mech/HP GREMLIN','shared');
